...
public interface VideoCommentMapper<T,P> extends BaseMapper<T,P> {
	...
	void updateCountInfo(@Param("commentId") Integer commentId,@Param("field") String field,
						 @Param("changeCount") Integer changeCount,@Param("opposeField") String opposeField,
